...
const CHAT_SEND_INPUT_SCHEMA = {
  ...
  properties: {
    ...
    forHuman: { type: "string", description: `A message ghostwritten as the SENDER speaking. Use the fewest words that faithfully preserve it; most agent-authored messages finish in 1-${FOR_HUMAN_DEFAULT_SENTENCE_LIMIT} normally sized sentences and ${FOR_HUMAN_TYPICAL_WORD_LIMIT} words or fewer. The review threshold applies only to MCP-authored text, never text typed by a person in the Relay pill.` },
...
export const TOOLS = [
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        forHuman: { type: "string", description: "The message in this human's voice. Identical composition rules to relay_send.forHuman: use the fewest words that faithfully preserve it, normally 1-3 sentences and 45 words or fewer. 60 words triggers Relay's mandatory review; it is not a target or a budget." },
  ...
  },
  {
    ...
    inputSchema: {
      type: "object",
      properties: {
        relayId: { type: "string" }, forHuman: { type: "string" },
