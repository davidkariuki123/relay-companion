...
export const RELAY_MCP_INSTRUCTIONS = [
  `Only send a Relay when the user asks you to send (or relay) something to someone. Relay is the user's default general direct-message and saved-channel communication layer; relay_send requires non-empty forAgent. ${EXPLICIT_PLAIN_TEXT_ROUTING} An explicitly requested other medium overrides Relay. For 'me', 'myself', or the human's own account, set recipient.self=true; do not search or mint a link. Resolve every other recipient with relay_contacts_search or relay_groups_list before sending. ${EXPLICIT_EMAIL_ROUTING} For received Relay, search relay_inbox_list; notification emails are not the authoritative contents.`,
...
export const REQUESTS_DISABLED_INSTRUCTIONS = [
  `Only send a Relay when the user asks you to send (or relay) something to someone. Relay is the user's default general direct-message and saved-channel communication layer; relay_send requires non-empty forAgent. ${EXPLICIT_PLAIN_TEXT_ROUTING} An explicitly requested other medium overrides Relay. For 'me', 'myself', or the human's own account, set recipient.self=true; do not search or mint a link. Resolve every other recipient with relay_contacts_search or relay_groups_list before sending. ${EXPLICIT_EMAIL_ROUTING} For something received through Relay, search relay_inbox_list; notification emails are not the authoritative contents.`,
