...
var require_purify_cjs = __commonJS({
  "../../node_modules/dompurify/dist/purify.cjs.js"(exports2, module2) {
    ...
    function createDOMPurify2() {
      ...
      const DOMPurify2 = (root) => createDOMPurify2(root);
...
function safeExternalUrl(value) {
  ...
  try {
    ...
    if (!(/* @__PURE__ */ new Set(["https:", "http:", "mailto:"])).has(parsed.protocol)) return null;
    return parsed.href;
  } catch {
    return null;
  }
...
contextBridge.exposeInMainWorld("relayPreview", {
  ...
  steer: (relayId, body, newTurn = false, clientMessageId = "") => ipcRenderer.invoke("relay:preview:steer", {
    relayId: String(relayId || ""),
    body: String(body || ""),
